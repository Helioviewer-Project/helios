...
export default function PreferenceControls(props: PreferenceControlProps): React.JSX.Element {
    ...
    return (
        ...
        >
            ...
            <Select className={preferencesCss.option}
                label="Resolution"
                value={resolution}
                ...
                options={resolutionOptions.map((val) => <option key={val.value} value={val.value}>{val.label}</option>)}
